...
def siteMonitor(host, https=False, www=False):
    """Tests HTTP response code for a given host"""
    ...
    response = requests.head(f"{protocol}{domainPrefix}{host}")
    ...
    return {
        "Site Monitor Hostname": host,
        "Site Monitor HTTP Status Code": response.status_code,
        "Site is Online": True,
    }
